...
module Spree
  module DefaultPrice
    ...
    #
    # In the case that a variant is discared, it also considers discarded
    # prices.
    #
    ...
    # @see Spree::Price.default_pricing
    def default_price
      base_prices = discarded? ? (prices + prices.with_discarded).uniq : prices.to_a
      base_prices.select do |price|
        price.
          attributes.
          values_at(
